...
namespace Microsoft.Maui.Graphics.Controls
{
    public class FluentDatePickerDrawable : ViewDrawable<IDatePicker>, IDatePickerDrawable
    {
        ...
        public void DrawDate(ICanvas canvas, RectangleF dirtyRect, IDatePicker view)
        {
            ...
            if (VirtualView.IsEnabled)
                canvas.FontColor = VirtualView.TextColor.WithDefault(Fluent.Color.Foreground.Black);
            else
                canvas.FontColor = VirtualView.TextColor.WithDefault(Fluent.Color.Foreground.NeutralTertiary);
